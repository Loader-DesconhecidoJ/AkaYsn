...
-- =========================================================
-- SCRIPT ATUALIZADO: Sem as ações (Deitar, Sentar, Agachar, Invisibilidade)
-- =========================================================
...
local ID_CONFIG = {
    ...
    JumpRunning = "rbxassetid://94661375975318",
    JumpStanding = "rbxassetid://94661375975318",
    IdleVariant = "rbxassetid://14618196485",
...
local function startIdleTimer()
    ...
    idleTimer = task.delay(10, function()
        idleTimer = nil
        if isIdle and SETTINGS.Enabled and not isDrinking then
            playIdleVariant()
        end
    end)
end
...
local function updateIdleStatus()
    ...
    local shouldBeIdle = not isDrinking
